...
Whenever a new "Context Map" is provided, you *must* update both `GEMINI.md` and `README.md` with the new map. The "Context Map" represents a nested navigation of all the paths and concepts within the Datamine Network. In `README.md`, the "Context Map" should be placed right after the "Quick Start Guide" section.
