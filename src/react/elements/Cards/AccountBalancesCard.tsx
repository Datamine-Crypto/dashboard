...
import { DialogType, FluxAddressDetails, FluxAddressLock, FluxAddressTokenDetails, Token } from '@/app/interfaces';
...
import { Balances, ReducerDispatch } from '@/app/interfaces';
