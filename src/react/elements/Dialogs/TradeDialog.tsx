...
const TradeDialog: React.FC = () => {
	...
	const { mintableTokenShortName, navigation, lockableTokenShortName, layer } = getEcosystemConfig(ecosystem);
	...
	const getLearnMoreBurningLink = () => {
		...
		return (
			<>
				{' '}
				<Link color="textSecondary" href="#help/uniswap/buyingDatamineTokens" rel="noopener noreferrer" target="_blank">
					Click here
				</Link>{' '}
				to learn more.
			</>
