export const marketAbi = [
	...
	},
	{
		...
		inputs: [
			...
			{ indexed: false, internalType: 'uint256', name: 'amountToBurnInput', type: 'uint256' },
			{ indexed: true, internalType: 'address', name: 'burnToAddress', type: 'address' },
			{ indexed: false, internalType: 'bytes', name: 'errorData', type: 'bytes' },
		],
	...
	},
	{
		...
		inputs: [
			...
			{ indexed: false, internalType: 'uint256', name: 'amountToReceive', type: 'uint256' },
			{ indexed: false, internalType: 'uint256', name: 'currentBlock', type: 'uint256' },
			{ indexed: false, internalType: 'uint256', name: 'amountToMint', type: 'uint256' },
		],
		name: 'TokensBurned',
		type: 'event',
	},
	...
	},
	{
		...
		outputs: [
			{ internalType: 'uint256', name: 'actualAmountBurned', type: 'uint256' },
			{ internalType: 'uint256', name: 'amountToMintValue', type: 'uint256' },
			{ internalType: 'uint256', name: 'tipAmountValue', type: 'uint256' },
		],
		stateMutability: 'nonpayable',
		type: 'function',
	},
